...
const GrowingSteps : React.FC = () => {
  return (
    <section className='w-full my-7 py-7 bg-white/10 backdrop-blur-md'>
      ...
      <div className='w-full flex items-center justify-center my-8 pt-15'>
        <div className='w-full md:w-4/5 mx-7 md:mx-15 flex flex-col-reverse md:flex-row items-start justify-between gap-7'>
          <div className='w-full md:w-1/3 mt-4'>
            {
              growingSteps.map((items) => (
                <div 
                  key={items.id}
                  className='flex flex-col md:flex-row items-center gap-10 mb-7'
                >
                  <h1
